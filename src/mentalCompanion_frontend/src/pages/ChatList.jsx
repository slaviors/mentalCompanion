  ...
  return (
    <div className="flex flex-col h-full bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto">
          {chatSessions.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center py-16">
              ...
              <h2 className="text-2xl font-bold text-gray-900">No conversations yet</h2>
              <p className="mt-2 max-w-md text-gray-600">Start a new conversation to get support from your Mental Health Companion.</p>
              <button
                onClick={handleCreateNewChat}
                ...
                >
                  ...
                  <div className="p-5">
                    <div className="flex justify-between items-start">
                      <h3 className="text-lg font-semibold text-gray-800 group-hover:text-teal-600 transition-colors">{chat.title}</h3>
                      <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-full">{formatTimestamp(chat.updatedAt)}</span>
                    </div>
      ...
      <div className="bg-white p-4 border-t text-center text-sm text-gray-500">
        ...
        <p className="mt-1">Current user: mamatqurtifa | {new Date().toLocaleDateString()}</p>
      </div>
    </div>
  );
}
